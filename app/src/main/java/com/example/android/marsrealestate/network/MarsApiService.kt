...
enum class MarsApiFiler(val value: String) { SHOW_RENT("rent"), SHOW_BUY("buy"), SHOW_ALL("all")}
...
private val retrofit = Retrofit.Builder()
        // Change the ConvertFactory to the MoshiConverterFactory with our Moshi Object
...
interface MarsApiService {
     ...
     * The @GET annotation indicated that the "realestate" endpoint will be requested with the GET
     * HTTP method
     */
    // Add filter @Query value to the getProperties method
    @GET("realestate")
