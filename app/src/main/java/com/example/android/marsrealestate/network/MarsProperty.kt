 ...
 * [MarsProperty] and [MarsApiService] [LiveData]. The Retrofit service returns a coroutine
 * Deferred, which we await to get the result of the transaction.
 * @param filter the [MarsApiService] that is sent as part of the web server request
 */
